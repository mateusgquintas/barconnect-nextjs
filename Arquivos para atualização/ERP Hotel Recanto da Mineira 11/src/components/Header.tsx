...
export function Header({ onNewComanda, onDirectSale, currentView, onViewChange, dashboardView, onDashboardViewChange, hotelView, onHotelViewChange, userRole, userName, onLogout }: HeaderProps) {
  const allNavItems = [
                ...
                <DropdownMenu key={item.id}>
                  ...
                  >
                    ...
                    <DropdownMenuItem
                      onClick={() => {
                        onViewChange('hotel');
                        onHotelViewChange('pilgrimages');
                      }}
                      className={`cursor-pointer ${
                        hotelView === 'pilgrimages'
                          ? 'bg-white/10 text-white'
                          : 'text-slate-300 hover:bg-white/10 hover:text-white'
                      }`}
                    >
